...
const oChicken = g_Gaia.chicken;

const fruitCount = g_ResourceCounts.fruit;
const fishCount = g_ResourceCounts.fish;
const mainHuntCount = g_ResourceCounts.mainHunt;
const secHuntCount = g_ResourceCounts.secHunt;
const stoneCount = g_ResourceCounts.stone;
const metalCount = g_ResourceCounts.metal;
...
createMines(
	...
	clRock,
	[scaleByMapSize(stoneCount.min, stoneCount.max)]);
...
createMines(
	...
	clMetal,
	[scaleByMapSize(metalCount.min, metalCount.max)]
);
...
createFood(
	...
	[
		scaleByMapSize(mainHuntCount.min, mainHuntCount.max),
		scaleByMapSize(secHuntCount.min, secHuntCount.max)
	],
...
createFood(
	...
	[
		scaleByMapSize(fruitCount.min, fruitCount.max)
	],
